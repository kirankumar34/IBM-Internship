...
router.post('/:id/members', authorize('super_admin', 'project_manager', 'team_leader'), addMemberToProject);

// Milestones
router.get('/:projectId/milestones', getMilestones);
router.post('/:projectId/milestones', authorize('super_admin', 'project_manager'), createMilestone);

// Standalone Milestone operations
router.put('/milestones/:id', authorize('super_admin', 'project_manager'), updateMilestone);
router.delete('/milestones/:id', authorize('super_admin', 'project_manager'), deleteMilestone);

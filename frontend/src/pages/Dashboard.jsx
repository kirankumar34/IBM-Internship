        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                    ...
                    { label: 'Completion Rate', value: '71%', type: 'circle' },
                    { label: 'Pending Tasks', value: '18,221', change: '11%', isPositive: true },
                ].map((item, index) => (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-96">
                {/* Chart Section */}
                <div className="lg:col-span-2 bg-dark-700 p-6 rounded-2xl border border-dark-600 relative">
                    ...
                    <div className="flex items-center h-full pb-10">
                        ...
                        <div className="w-1/2 space-y-4">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center text-sm text-dark-500"><div className="w-2 h-2 rounded-full bg-primary mr-2"></div>Completed</div>
                                <span className="text-white font-bold">{completedProjects}</span>
                            </div>
                            <div className="flex items-center justify-between">
                                <div className="flex items-center text-sm text-dark-500"><div className="w-2 h-2 rounded-full bg-white mr-2"></div>Active</div>
                                <span className="text-white font-bold">{activeProjects}</span>
                            </div>
                            <div className="flex items-center justify-between">
                                <div className="flex items-center text-sm text-dark-500"><div className="w-2 h-2 rounded-full bg-dark-500 mr-2"></div>Planning</div>
                                <span className="text-white font-bold">{totalProjects - activeProjects - completedProjects}</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-dark-700 p-6 rounded-2xl border border-dark-600 h-[calc(50%-12px)] relative overflow-hidden">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 h-16">
                            <ResponsiveContainer width="100%" height="100%">
                                <AreaChart data={data}>
                                    ...
                                    <Area type="monotone" dataKey="value" stroke="#10B981" fillOpacity={1} fill="url(#colorPv)" />
                                </AreaChart>
                            </ResponsiveContainer>
                        </div>
                    </div>
            ...
            {showModal && (
                <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4 z-50">
                    <div className="bg-dark-700 rounded-2xl border border-dark-600 max-w-lg w-full p-6 shadow-2xl">
                        ...
                        <form onSubmit={handleCreate} className="space-y-4">
                            ...
                            <div className="flex justify-end space-x-3 mt-6">
                                ...
                                <button type="submit" className="px-6 py-2 bg-primary text-dark-900 font-bold rounded-xl hover:bg-primary-hover">Create Project</button>
                            </div>
                        </form>
                    </div>
                </div>
